...
// NewListener返回一个listener用于在peers之间传送raft message
// 它使用一个timeout listener及时地识别出broken streams
...
// NewRoundTripper返回一个roundTripper，用来发送请求到remote peers的rafthttp listener
